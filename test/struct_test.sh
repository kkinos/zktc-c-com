...
zktc-asm asm/struct_test1.asm -o mem/struct_test1.mem -b 0x8000
...
zktc-asm asm/struct_test2.asm -o mem/struct_test2.mem -b 0x8000
...
zktc-asm asm/struct_test3.asm -o mem/struct_test3.mem -b 0x8000

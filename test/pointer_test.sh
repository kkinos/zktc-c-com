...
zktc-asm asm/pointer_test1.asm -o mem/pointer_test1.mem -b 0x8000
...
zktc-asm asm/pointer_test2.asm -o mem/pointer_test2.mem -b 0x8000
...
zktc-asm asm/pointer_test3.asm -o mem/pointer_test3.mem -b 0x8000
